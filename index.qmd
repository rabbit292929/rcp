...
* [**David Wu**](https://research.monash.edu/en/persons/david-wu). Email: [david.wu1@monash.edu](mailto:david.wu1@monash.edu)
* [**Naveen Kaushik**](https://www.linkedin.com/in/naveen-kaushik/).
...
* Michael Lydeamore: Thursday 3pm-4pm each week
* David Wu: Tuesday 4-5pm each week
...
schedule |>
  transmute(
    ...
    Tutorial = if_else(!Show, "", glue::glue('[{{< fa list-check >}}](./week{{{Week}}}/tutorial/index.html){target="_blank"}', .open="{{{", .close="}}}")),
