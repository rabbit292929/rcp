...
format:
    unilur-html:
        output-file: tutorial-05-question.html
        embed-resources: true
    unilur-html+solution:
        output-file: tutorial-05-solution.html
        embed-resources: true
---
...
13. Stage, commit and push the chainges into `main` in your remote repo
...
15. Create a new file called `ignoring.txt` and a new file called `gitignore` using `touch`. Make sure the files are create in your repo using `ls -a`. State ghese files, commit and push them.
